...
CREATE POLICY "Allow all access to unnecessary_expenses" ON unnecessary_expenses FOR ALL USING (true);
...
CREATE POLICY "Allow all access to budget_entries" ON budget_entries FOR ALL USING (true);
CREATE POLICY "Allow all access to budget_expenses" ON budget_expenses FOR ALL USING (true);
